...
class TwitterProxy {
	 ...
	 */
	public function __construct($oauth_access_token, $oauth_access_token_secret, $consumer_key, $consumer_secret, $search, $type, $count = 7) {
		...
		$this->whitelist['search/tweets.json?q=' . $this->config['search'] . '&result_type='  . $this->config['type'] . '&count=' . $this->config['count']] = true;
	}
